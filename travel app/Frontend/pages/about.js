...
import john from "../pages/images/me.jpg";
...
const About = () => {
  ...
  <div className="work-section-wrapper">
      <div className="work-section-top">
        ...
        <h1 className="primary-heading">What </h1>
        <p className="primary-text">
          We create user friendly website for the users 
        </p>
      </div>
      <div className="testimonial-section-bottom">
        <img src={john} alt="" />
        <p>
          We hope that our idea make your dream come true in future we will upgrade this site 
          to your exceptations.
        </p>
